...
from .schemas import CustomerData, PaymentResponse, PaymentData, Request
# from .validators import CustomerValidator, PaymentDataValidator
from validators import chain_handler
from factory_pattern.factory import PaymentProcessorFactory
...
class PaymentService:
    ...
    def create_with_payment_processor(cls, payment_data : PaymentData, **kwargs) -> Self:
        try:
            ...
            return cls(ppayment_processor=processor, **kwargs)
        except ValueError as e:
            print("Error creando la clase.")
            raise e

    def set_notifier(self, notifier : Notifier):
        print("Estamos cambiando la imlemenacion del notificador")
    ...
    def process_transaction(
        ...
        self.listeners.notify_all(f"Pago exitoso al evento {payment_response.transaction_id}")
